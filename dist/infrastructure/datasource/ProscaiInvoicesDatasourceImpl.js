...
class ProscaiInvoicesDatasourceImpl extends invoices_datasource_1.InvoicesDatasource {
    getInvoices(invoicePaginationDto) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const startDateValueDefault = startDate !== null && startDate !== void 0 ? startDate : '2024-01-01';
            ...
            let whereClauses = [
                ...
                'f.DSTATUSCFD = ?',
                "( MID(DNUM,1,1)= 'F' OR MID(DNUM,1,1)= 'D' OR MID(DNUM,1,1)= 'A'  OR MID(DNUM,1,1)= 'I' OR MID(DNUM,1,1)= 'C'  )"
            ];
            let likeClauses = [];
            let values = [1, 3];
            if (branchsOffice) {
